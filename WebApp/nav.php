...
?>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #D3D3D3;">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a href="login.php" class="navbar-brand"><i class="bi bi-pencil-square"></i>เข้าสู่ระบบ</a>
                </li>
            </ul> 
        </div>
    </nav>
            ...
            <ul class="navbar-nav">
                <div class="dropdown">
                    <a class="btn btn-outline-secondary dropdown-toggle btn-sm" type="button" id="button1" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        ?></a>
                        <li class="dropdown-menu" aria-labelledby="button1"><a href="logout.php" class="dropdown-item">
